                ...
                <div className="container">
                    <div className="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                        <div className="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                            <p className="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span className="mr-2"><a href="Home.jsx">Home</a></span> <span>Contact</span></p>
                    ...
                    <div className="row block-9">
                        <div className="col-md-6 pr-md-5">
                            <form action="#">
                                ...
                                <div className="form-group">
                                    <textarea name='message' id='message' cols={30} rows={7} className="form-control" placeholder="Message" defaultValue={""} />
                                </div>
                                <div className="form-group">
