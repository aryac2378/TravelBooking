                ...
                <div className="container">
                    <div className="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                        <div className="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                            <p className="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span className="mr-2"><a href="Home.jsx">Home</a></span> <span className="mr-2"><a href="Hotel.jsx">Hotel</a></span> <span>Hotel Single</span></p>
                                    ...
                                    <div className="fields">
                                        ...
                                        <div className="form-group">
                                            <div className="select-wrap one-third">
                                                ...
                                                <select name='seacrh' id='seacrh' className="form-control" placeholder="Keyword search">
                            ...
                            <div className="row">
                                <div className="col-md-12 ftco-animate">
                                    <div className="single-slider owl-carousel">
                                        <div className="item">
                                            <div className="hotel-img" style={{ backgroundImage: 'url(images/hotel-2.jpg)' }} />
                                        </div>
                                        <div className="item">
                                            <div className="hotel-img" style={{ backgroundImage: 'url(images/hotel-3.jpg)' }} />
                                        </div>
                                        <div className="item">
                                            <div className="hotel-img" style={{ backgroundImage: 'url(images/hotel-4.jpg)' }} />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
                                    ...
                                    <p className="rate mb-5">
                                        <span className="loc"><a href="#"><i className="icon-map" /> 291 South 21th Street, Suite 721 New York NY 10016</a></span>
                                        <span className="star">
                                    ...
                                    <div className="row">
                                        <div className="col-md-4">
                                            <div className="destination">
                                                <a href="HotelSingle.jsx" className="img img-2" style={{ backgroundImage: 'url(images/room-4.jpg)' }} />
                                        ...
                                        <div className="col-md-4">
                                            <div className="destination">
                                                <a href="HotelSingle.jsx" className="img img-2" style={{ backgroundImage: 'url(images/room-5.jpg)' }} />
                                                <div className="text p-3">
                                                    <div className="d-flex">
                                                        <div className="one">
                                                            <h3><a href="HotelSingle.jsx">Hotel, Italy</a></h3>
                                        ...
                                        <div className="col-md-4">
                                            <div className="destination">
                                                <a href="HotelSingle.jsx" className="img img-2" style={{ backgroundImage: 'url(images/room-6.jpg)' }} />
                                                <div className="text p-3">
                                                    <div className="d-flex">
                                                        <div className="one">
                                                            <h3><a href="HotelSingle.jsx">Hotel, Italy</a></h3>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <div className="select-wrap one-third">
                                                        <div className="icon"><span className="ion-ios-arrow-down" /></div>
                                                        <select name='guest' id='guest' className="form-control" placeholder="Guest">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <div className="select-wrap one-third">
                                                        <div className="icon"><span className="ion-ios-arrow-down" /></div>
                                                        <select name='children' id='children' className="form-control" placeholder="Children">
                                            ...
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    <input type="submit" defaultValue="Check Availability" className="btn btn-primary py-3" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-md-12 hotel-single ftco-animate mb-5 mt-5">
                                    ...
                                    <div className="row">
                                        <div className="col-md-4">
                                            <div className="destination">
                                                <a href="HotelSingle.jsx" className="img img-2" style={{ backgroundImage: 'url(images/hotel-1.jpg)' }} />
                                                <div className="text p-3">
                                                    <div className="d-flex">
                                                        <div className="one">
                                                            <h3><a href="HotelSingle.jsx">Hotel, Italy</a></h3>
                                        ...
                                        <div className="col-md-4">
                                            <div className="destination">
                                                <a href="HotelSingle.jsx" className="img img-2" style={{ backgroundImage: 'url(images/hotel-2.jpg)' }} />
                                                <div className="text p-3">
                                                    <div className="d-flex">
                                                        <div className="one">
                                                            <h3><a href="HotelSingle.jsx">Hotel, Italy</a></h3>
                                        ...
                                        <div className="col-md-4">
                                            <div className="destination">
                                                <a href="HotelSingle.jsx" className="img img-2" style={{ backgroundImage: 'url(images/hotel-3.jpg)' }} />
                                                <div className="text p-3">
                                                    <div className="d-flex">
                                                        <div className="one">
                                                            <h3><a href="HotelSingle.jsx">Hotel, Italy</a></h3>
